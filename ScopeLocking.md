My Question: So for the thread scope locking, do we lock it the moment we establish a student intent above a level of confidence, and thereafter all added units can only be added deterministically? I need to undersatnd how a thread "boots up"


Yes — that’s the clean MVP story. A thread “boots up” in **two phases**:

1. **Bootstrap (unlocked / finding intent)**
2. **Locked scope (normal tutoring)**
